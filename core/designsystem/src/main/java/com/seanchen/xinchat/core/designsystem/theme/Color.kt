 ...
 * 警告色：#FFB703
 */
val ColorWarning = Color(0xFFFFB703)
 ...
 * 浅色模式下次要文字颜色：#333333
 */
val TextSecondaryLight = Color(0xFF333333)

/**
 * 浅色模式下三级文字颜色：#B2B2B2
 */
val TextTertiaryLight = Color(0xFFB2B2B2)

/**
 * 浅色模式下四级文字颜色：#CCCCCC
 */
val TextQuaternaryLight = Color(0xFFCCCCCC)
 ...
 * 深色模式下主要文字颜色：#D1D1D1
 */
val TextPrimaryDark = Color(0xFFA3A3A3)
